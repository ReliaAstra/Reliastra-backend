...
class GitHubAuthService:
    ...
    def _resolve_email(
        ...
        Priority: profile email (if public) > primary verified email > noreply fallback.
        """
        ...
        # 4. Fallback: GitHub noreply address
    ...
    async def authenticate_with_code(
        ...
        email = self._resolve_email(github_user, github_emails)
