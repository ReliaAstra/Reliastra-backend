...
class AiProvider(Base):
    """Provider-agnostic LLM configuration (Phase 8).

    API keys are stored Fernet-encrypted at rest. The AI layer only ever
    receives pre-computed, deterministic evidence — it explains, never decides.
    """
